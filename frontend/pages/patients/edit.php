...
$formData = [
    ...
    'height_cm' => safeFloat($patient, 'height_cm'),
    'weight_kg' => safeFloat($patient, 'weight_kg'),
    'blood_pressure' => safeStr($patient, 'blood_pressure', ''),
...
<div style="max-width: 900px; margin: 0 auto;">
    ...
    <div class="page-header">
        <div class="flex items-center gap-4">
            <a href="<?php echo baseUrl('/patients/view?id=' . $patientId); ?>" class="btn btn-icon btn-outline">
    ...
    <form method="POST" action="<?php echo baseUrl('/patients/edit?id=' . $patientId); ?>">
        <?php echo csrfField(); ?>
        ...
        <div class="form-actions">
            <a href="<?php echo baseUrl('/patients/view?id=' . $patientId); ?>" class="btn btn-secondary">Cancel</a>
